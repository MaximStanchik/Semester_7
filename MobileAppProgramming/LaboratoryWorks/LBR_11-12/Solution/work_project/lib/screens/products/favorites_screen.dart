...
class FavoritesScreen extends StatelessWidget {
          ...
          builder: (context, favoritesState) {
            if (favoritesState is FavoritesInitial) {
              ...
              WidgetsBinding.instance.addPostFrameCallback((_) {
                context.read<FavoritesBloc>().add(FavoritesLoadRequested(uid));
              });
              return const Center(child: CircularProgressIndicator());
            }
  ...
  Widget _buildFavoriteCard(BuildContext context, Product product, String userId, int index) {
    ...
    final ImageProvider<Object>? imageProvider = imagePath.isEmpty
        ? null
