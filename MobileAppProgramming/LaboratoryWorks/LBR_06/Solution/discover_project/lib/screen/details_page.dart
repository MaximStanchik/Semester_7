...
class DetailsPage extends StatelessWidget {
  ...
  final String? image;
  const DetailsPage({super.key, this.title, this.description, this.image});
  ...
  Widget build(BuildContext context) {
    ...
    if (image != null && image!.isNotEmpty) {
      imageWidget = Image.asset(
        ...
        errorBuilder: (context, error, stackTrace) => 
          Container(
            ...
            child: Icon(Icons.image_not_supported, size: 64, color: Colors.deepPurple[200]),
          ),
      );
    } else {
      imageWidget = Container(
        ...
        child: Icon(Icons.image_outlined, size: 64, color: Colors.deepPurple[200]),
      );
    }
    return Scaffold(
